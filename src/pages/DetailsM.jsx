...
import { faCalendar, faFilm, faStar } from '@fortawesome/free-solid-svg-icons'
...
const DetailsM = () => {
  ...
  useEffect(() => {
    ...
    const fetchData = async () => {
      try {
        const response = await fetch(`https://api.themoviedb.org/3/movie/${id}?api_key=d49022b6e815498ef21ab7e6a697cd9b`);
          ...
          <>
            <div className="section-left">
              ...
              <div className="movie-rating">
                ...
                <div>
                  <span className='ttl'>Release date : <FontAwesomeIcon icon={faCalendar}/></span>
                  <span id='rd'>{data.release_date}</span>
                </div>
              </div>
